...
public class TutorialController : MonoBehaviour {
    ...
    /*5*/    tutorialTexts.Add("Click on the main building to display possible actions.");
    ...
    /*10*/    tutorialTexts.Add("Now you can select the material you want. The gatherer will go automatically to the nearest ore.\nFirst, select water");
    ...
    /*15*/    tutorialTexts.Add("Now click on the main building and create a soldier ship");
    ...
    /*20*/    tutorialTexts.Add("Keep track of your resources! If you stay 15 days with negative of any of them, you will fail!");
